...
if("TRUE" STREQUAL "TRUE")
  set(map_merger_SOURCE_PREFIX /home/matteo/final_ws/src/map_merger)
  set(map_merger_DEVEL_PREFIX /home/matteo/final_ws/src/build/devel)
  ...
  set(map_merger_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/matteo/final_ws/src/map_merger/include " STREQUAL " ")
  set(map_merger_INCLUDE_DIRS "")
  set(_include_dirs "/home/matteo/final_ws/src/map_merger/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'DanieleSerafini <dontremember@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_merger' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/matteo/final_ws/src/map_merger/${idir}'.  ${_report}")
    endif()
...
set(map_merger_EXPORTED_TARGETS "")
...
set(depends "roscpp;rospy;tf;rtabmap_ros")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(map_merger_EXPORTED_TARGETS ${${map_merger_dep}_EXPORTED_TARGETS})
endforeach()
